...
<br><br>**1.** Переходимо до розділу "[Посилання](https://github.com/INDMops/deltarune-ua#Посилання)" -> "[Завантаження мода](https://github.com/INDMops/deltarune-ua#Посилання###Завантаження_мода)" та обираємо зручний для себе спосіб завантаження моду, потім обираємо останню версію яка є наразі.
<br><br>
